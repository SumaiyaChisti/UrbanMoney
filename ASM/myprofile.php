...
if(isset($_POST['submit']))
{
    ...
    $q="UPDATE `staff` SET `name`='$name',`email`='$email',`contact`='$contact',`branch_manager`='$branch_manager',`zonal-sales_manager`='$zonal_sales_manager',`campaign`='$campaign'   WHERE `id`='$_GET[id]'";
    $d= mysqli_query($conn, $q);
    if ($d){
