...
if(isset($_POST['submit'])) {
  ...
  $fullpath12 = $dir . basename($_FILES['OC']['name']);
  move_uploaded_file($_FILES['OC']['tmp_name'],$fullpath12);
  $fullpath13 = $dir . basename($_FILES['CC']['name']);
  move_uploaded_file($_FILES['CC']['tmp_name'],$fullpath13);
