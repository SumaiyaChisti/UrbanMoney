...
if(isset($_POST['submit'])) {
  ...
  $fullpath1 = $dir . basename($_FILES['aadhar_card']['name']);
  move_uploaded_file($_FILES['aadhar_card']['tmp_name'],$fullpath1);
  ...
  move_uploaded_file($_FILES['official_email']['tmp_name'],$fullpath7);
    $q = "INSERT INTO `form1`(`name`,`dob`,`gender`,
    `contact`,`email`,`address`,`pan_id`,
    `property_ownership`,`marital_status`,
    `place_of_work`,`job_title`,
    `work_address`,`years_employed`,
    `monthly_net_income`,`pan_card`,
    `aadhar_card`,`bill`,`salary_slip`,
    `id_card`,`six_months_banking`,`two_years_form16`,
    `official_email`,`bank_name`,`branch_name`,
    `account_number`,`account_type`,`purpose_of_loan`,
    `requested_loan_amount`,`terms_in`)
    VALUES ('$_POST[name]','$_POST[dob]',
    '$_POST[gender]','$_POST[contact]',
    '$_POST[email]','$_POST[address]',
    '$_POST[pan_id]','$_POST[property_ownership]',
    '$_POST[marital_status]','$_POST[place_of_work]',
    '$_POST[job_title]','$_POST[work_address]',
    '$_POST[years_employed]',
    '$_POST[monthly_net_income]',
    '$fullpath','$fullpath1',
    '$fullpath2','$fullpath3','$fullpath4','$fullpath5',
    '$fullpath6','$fullpath7','$_POST[bank_name]',
    '$_POST[branch_name]','$_POST[account_number]',
    '$_POST[account_type]','$_POST[purpose_of_loan]',
