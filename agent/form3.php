...
if(isset($_POST['submit'])) {
  ...
  $fullpath11 = $dir . basename($_FILES['GST_3B']['name']);
  move_uploaded_file($_FILES['GST_3B']['tmp_name'],$fullpath11);
  $fullpath12 = $dir . basename($_FILES['GST_registration']['name']);
  move_uploaded_file($_FILES['GST_registration']['tmp_name'],$fullpath12);
    $q = "INSERT INTO `form3`(`name`,`dob`,`gender`,`contact`,`email`,`address`,`pan_id`,`property_ownership`,`marital_status`,`place_of_work`,`job_title`,`work_address`,`years_employed`,`monthly_net_income`,`pan_card`,`aadhaar_card`,`residential_bill`,`license`,`tax_receipt`,`ITRfinancials_AuditReport`,`bank_statement`,`bank_statement_Saving_Accounts`,`ongoing_loans`,`photographs`,`business_proof`,`GST_3B`,`GST_registration`,`bank_name`,`branch_name`,`account_number`,`account_type`,`purpose_of_loan`,`requested_loan_amount`,`terms_in`)VALUES ('$_POST[name]','$_POST[dob]','$_POST[gender]','$_POST[contact]','$_POST[email]','$_POST[address]','$_POST[pan_id]','$_POST[property_ownership]','$_POST[marital_status]','$_POST[place_of_work]','$_POST[job_title]','$_POST[work_address]','$_POST[years_employed]','$_POST[monthly_net_income]','$fullpath','$fullpath1','$fullpath2','$fullpath3','$fullpath4','$fullpath5','$fullpath6','$fullpath7','$fullpath8','$fullpath9','$fullpath10','$fullpath11','$fullpath12','$_POST[bank_name]','$_POST[branch_name]','$_POST[account_number]','$_POST[account_type]','$_POST[purpose_of_loan]','$_POST[requested_loan_amount]','$_POST[terms_in]')";
