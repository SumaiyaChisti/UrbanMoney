...
<div class="container">
    ...
    $d=$conn->query("SELECT * FROM `form8` WHERE `id`='$_GET[id]'");
            ...
            <div class="col-md-4 mb-3">
              ...
              <div class="card mt-3">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0"></path></svg>Last 3 Years ITR Of Company And indiviual.</h6>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                <h6 class="mb-0"></path></svg>Sale Agreement Copy/Draft Agreement</h6>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0"></path></svg>LOD(List Of Documents).</h6>
                    <span><a target="_blank" class="btn" href="../agent/<?php echo $r['LOD']?>"><i class="fa fa-download"  ></i></a></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0"></path></svg>OutStanding Letter</h6>
                    <span><a target="_blank" class="btn" href="../agent/<?php echo $r['outstanding_letter']?>"><i class="fa fa-download"  ></i></a></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0"></path></svg>Last 12 Months GST 3B Applicable</h6>
                  <br><span><a target="_blank" class="btn" href="../agent/<?php echo $r['GST_3B']?>"><i class="fa fa-download"  ></i></a></span>
                  </li>
                </ul>
              </div>
            </div>
