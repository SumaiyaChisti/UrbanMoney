...
function showData(id,btn,email,event)
{
...
function showData1(id1,btn,email,event)
{
...
function showData2(id2,btn,email,event)
{
...
function showData3(id3,btn,email,event)
{
...
function showData4(id4,btn,email,event)
{
