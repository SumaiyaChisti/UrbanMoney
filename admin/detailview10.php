...
<div class="container">
    ...
    $d=$conn->query("SELECT * FROM `form10` WHERE `id`='$_GET[id]'");
            ...
            <div class="col-md-4 mb-3">
              ...
              <div class="card mt-3">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0"></path></svg>Residentail Light Bill And Telephone Bill-Latest Month</h6>
                  ...
                  <span><a target="_blank" class="btn" href="../agent/<?php echo $r['saving_banking']?>"><i class="fa fa-download"  ></i></a></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
