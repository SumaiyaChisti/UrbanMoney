...
if(isset($_SESSION['Manager'])){
    $Q="SELECT * FROM `staff` WHERE `email`='$_SESSION[Manager]'";
...
if(isset($_POST['submit']))
{
    ...
    $q="UPDATE `staff` SET `name`='$name',`email`='$email',`contact`='$contact',`manager`='$manager',`branch_manager`='$branch_manager',`area_sales_manager`='$area_sales_manager',`zonal-sales_manager`='$zonal_sales_manager',`campaign`='$campaign'   WHERE `id`='$_GET[id]'";
    $d= mysqli_query($conn, $q);
    if ($d){
